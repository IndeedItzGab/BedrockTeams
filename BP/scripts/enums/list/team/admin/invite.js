...
enumRegistry("invite", (origin, args) => {
  ...
  if(player.teamPerks().teamLimit < team.members.length + 1) return player.sendMessage(`${chatName} §4Your team is maximum sizs, kick someone out before inviting more people`)
